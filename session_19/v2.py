...
# create mappings from 
stoi = { ch:i for i, ch in enumerate(chars)}
itos = { i:ch for i,ch in enumerate(chars)}
encode = lambda s: [stoi[c] for c in s] # encoder: integers for the string
decode = lambda l: ''.join([itos[i] for i in l]) # decoder: strings for given integers
...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        # perform the weighted aggregate of the values
...
class Block(nn.Module):
    """ Transformer block: communication followed by comptation"""
...
class BigramLanguageModel(nn.Module):
    ...
    def generate(self, idx, max_new_tokens):
        ...
        for _ in range(max_new_tokens):
            ...
            # append sampled index to running sdequence
